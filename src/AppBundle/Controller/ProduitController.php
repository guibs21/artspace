...
use AppBundle\Entity\Products; // notre entité
...
class ProduitController extends Controller
{
    ...
    */
     public function suppAction($id, Request $request) {
        ...
        $rc = $doctrine->getRepository('AppBundle:Products');
    ...
    */
     public function indexAction() {
        ...
        $produits = $this->getDoctrine()->getRepository('AppBundle:Products')->findAll();
